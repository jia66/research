...
dataset_dir=/data/jia0/faster-rcnn-inception-resnet-v2-coco-2018-01-28 # 数据集目录，这里是写死的，记得修改
...
# 导出模型
python ./object_detection/export_inference_graph.py --input_type image_tensor --pipeline_config_path $pipeline_config_path --trained_checkpoint_prefix $train_dir/model.ckpt-200000 --output_directory $output_dir/exported_graphs
